...
export default function AssigneePicker({ assignee, onChange, size = 'sm', dropUp = false }) {
  ...
  const teammate = TEAMMATES.find((t) => t.name === assignee);
  ...
  return (
    <div className="relative flex-none">
      ...
      >
        {teammate ? (
          <span className="inline-block h-1.5 w-1.5 rounded-full" style={{ backgroundColor: teammate.color }} />
        ) : (
