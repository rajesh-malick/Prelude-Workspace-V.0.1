...
//
// `showCard` holds the text bubble back while the one-time WelcomeToast is
// still on screen — both sit in the same central-top region, and showing
// both at once reads as a layout bug, not two intentional messages.
export default function EmptySeed({ onLoadExamples, showCard = true }) {
